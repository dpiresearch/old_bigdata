...
hdSrBaseDir=/user/data/bolt/data/dev/tests/data/search_results
hdSBaseDir=/user/data/bolt/data/dev/tests/data/search_page
hdVAdBaseDir=/user/data/bolt/data/dev/tests/data/viewad;
