...
echo pig -param inputdir=$inputdir -param outputdir=$outputdir -param thedate=$thedate -param olddate=$olddate -f $DEPLOY_DIR/pig/events/dedupeCounts.pig
pig -param inputdir=$inputdir -param outputdir=$outputdir -param thedate=$thedate -param olddate=$olddate -param deploydir=$deploydir -f $DEPLOY_DIR/pig/events/dedupeCounts.pig
