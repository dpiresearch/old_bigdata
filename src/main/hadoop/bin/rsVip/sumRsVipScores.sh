...
echo hadoop fs -rmr $outputdir/$thedate/rs_sum
hadoop fs -rmr $outputdir/$thedate/rs_sum

echo pig -param deploydir=$deploydir -param inputdir=$inputdir -param outputdir=$outputdir -param refdir=$refdir -param daydate=$thedate -f $DEPLOY_DIR/pig/rsVip/sumRsVipScores.pig

pig -param deploydir=$deploydir -param inputdir=$inputdir -param outputdir=$outputdir -param refdir=$refdir -param daydate=$thedate -f $DEPLOY_DIR/pig/rsVip/sumRsVipScores.pig
