...
cat popular_search/*/rs_scores/part* > ~/rsvip_scores.csv
...
echo scp ~/rsvip_scores.csv ${username}@bo-qabatch001:/tmp
scp ~/rsvip_scores.csv ${username}@bo-qabatch001:/tmp
scp ~/rsvip_scores.csv ${username}@bo-qabatch002:/tmp
