...
hadoop fs -rmr $outputdir/*/rs_scores
...
do
  ...
  echo pig -param deploydir=$deploydir -param refdir=$refdir -param inputdir=$inputdir -param outputdir=$outputdir -param day=$var -param daydate=$thedate -f $deploydir/pig/rsVip/scoreRsVip.pig
  pig -param deploydir=$deploydir -param refdir=$refdir -param inputdir=$inputdir -param outputdir=$outputdir -param day=$var -param daydate=$thedate -f $deploydir/pig/rsVip/scoreRsVip.pig
done
