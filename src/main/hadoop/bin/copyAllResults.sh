...
# scp /tmp/keyword_search_sum.csv $result_dest:/tmp
scp /tmp/keyword_search_sum.csv bo-qabatch001:/tmp
scp /tmp/keyword_search_sum.csv bo-qabatch002:/tmp

scp /tmp/popularsearchresults.csv bo-qabatch001:/tmp
scp /tmp/popularsearchresults.csv bo-qabatch002:/tmp
