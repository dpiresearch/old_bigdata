...
scp /tmp/keyword_search_sum.csv csandiri@bo-qabatch001:/tmp
scp /tmp/keyword_search_sum.csv csandiri@bo-qabatch002:/tmp

scp /tmp/popularsearchresults.csv csandiri@bo-qabatch001:/tmp
scp /tmp/popularsearchresults.csv csandiri@bo-qabatch002:/tmp
